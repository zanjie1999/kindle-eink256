.class public Lcom/amazon/ku/util/KuConversionUtils;
.super Ljava/lang/Object;
.source "KuConversionUtils.java"


# static fields
.field private static final DBS_REQUEST_HEADER_KSTORE_KEY:Ljava/lang/String; = "x-amzn-kstore"
...
.method private static buildDbsRequestHeaders(Landroid/content/Context;)Ljava/util/Map;
    .locals 4
    ...
    const-string/jumbo v1, "x-amzn-kstore"
...
.method public static createRequestQueue(I)Lcom/android/volley/RequestQueue;
    .locals 4
    ...
    invoke-static {v2}, Lcom/amazon/ku/util/KuConversionUtils;->getCacheDirectory(Landroid/content/Context;)Ljava/io/File;
    ...
    invoke-direct {v3, v0}, Lcom/amazon/bookwizard/http/AuthenticationAwareHurlStack;-><init>(Landroid/content/Context;)V
    ...
    invoke-direct {v0, v1, v2, p0}, Lcom/android/volley/RequestQueue;-><init>(Lcom/android/volley/Cache;Lcom/android/volley/Network;I)V
...
.method public static getCacheDirectory(Landroid/content/Context;)Ljava/io/File;
    ...
    const-string p0, "/cache/ku_conversion"
...
.method public static getDbsRequestHeaders(Landroid/content/Context;)Ljava/util/Map;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 125
    invoke-static {p0}, Lcom/amazon/ku/util/KuConversionUtils;->buildDbsRequestHeaders(Landroid/content/Context;)Ljava/util/Map;

    move-result-object p0

    .line 126
    invoke-static {p0}, Lcom/amazon/ku/util/KuConversionUtils;->setDbsHeaderInCookies(Ljava/util/Map;)V
...
.method public static isAccessibilityModeOn()Z
    .locals 2
...
.method private static setDbsHeaderInCookies(Ljava/util/Map;)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {v2, v1}, Lcom/amazon/ku/util/KuConversionUtils;->buildCookie(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
