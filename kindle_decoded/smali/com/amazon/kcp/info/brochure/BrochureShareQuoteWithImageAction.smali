.class public Lcom/amazon/kcp/info/brochure/BrochureShareQuoteWithImageAction;
.super Lcom/amazon/kcp/info/brochure/BrochureQuoteShareAction;
.source "BrochureShareQuoteWithImageAction.java"


# static fields
.field private static final LOG_TAG:Ljava/lang/String; = "BrochureShareQuoteWithImageAction"
...
.method public share(Lcom/amazon/kcp/info/brochure/BrochureSlideShareMetadata;)V
    ...
    .line 47
    invoke-virtual {p1}, Lcom/amazon/kcp/info/brochure/BrochureSlideShareMetadata;->getQuoteText()Ljava/lang/String;

    move-result-object v2

    const-string v3, "com.amazon.kindle.socialsharing.EXTRA_QUOTE"

    .line 46
    invoke-virtual {v0, v3, v2}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Ljava/lang/String;)Landroid/content/Intent;

    .line 49
    invoke-virtual {p1}, Lcom/amazon/kcp/info/brochure/BrochureSlideShareMetadata;->getQuoteStartPosition()Ljava/lang/String;

    move-result-object v2

    const-string v3, "com.amazon.kindle.socialsharing.EXTRA_START_POSITION"

    .line 48
    invoke-virtual {v0, v3, v2}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Ljava/lang/String;)Landroid/content/Intent;

    .line 51
    invoke-virtual {p1}, Lcom/amazon/kcp/info/brochure/BrochureSlideShareMetadata;->getQuoteEndPosition()Ljava/lang/String;

    move-result-object v2

    const-string v3, "com.amazon.kindle.socialsharing.EXTRA_END_POSITION"

    .line 50
    invoke-virtual {v0, v3, v2}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Ljava/lang/String;)Landroid/content/Intent;

    .line 53
    invoke-virtual {p1}, Lcom/amazon/kcp/info/brochure/BrochureSlideShareMetadata;->getQuoteLanguage()Ljava/lang/String;

    move-result-object v2

    const-string v3, "com.amazon.kindle.socialsharing.EXTRA_CONTENT_LANGUAGE"
