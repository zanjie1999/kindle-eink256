...
.method public collect(Ljava/lang/Throwable;)Ljava/util/Map;
    ...
    .line 33
    iget-object p1, p0, Lcom/amazon/device/crashmanager/rtla/RtlaCrashDetailsCollectable;->mRtlaCrashDetails:Lcom/amazon/device/crashmanager/rtla/RtlaCrashDetails;

    invoke-interface {p1}, Lcom/amazon/device/crashmanager/rtla/RtlaCrashDetails;->getSessionId()Ljava/lang/String;

    move-result-object p1

    .line 34
    iget-object v0, p0, Lcom/amazon/device/crashmanager/rtla/RtlaCrashDetailsCollectable;->mRtlaCrashDetails:Lcom/amazon/device/crashmanager/rtla/RtlaCrashDetails;

    invoke-interface {v0}, Lcom/amazon/device/crashmanager/rtla/RtlaCrashDetails;->getUserAgent()Ljava/lang/String;

    move-result-object v0

    .line 35
    iget-object v1, p0, Lcom/amazon/device/crashmanager/rtla/RtlaCrashDetailsCollectable;->mRtlaCrashDetails:Lcom/amazon/device/crashmanager/rtla/RtlaCrashDetails;

    invoke-interface {v1}, Lcom/amazon/device/crashmanager/rtla/RtlaCrashDetails;->getPageType()Ljava/lang/String;

    move-result-object v1

    .line 36
    iget-object v2, p0, Lcom/amazon/device/crashmanager/rtla/RtlaCrashDetailsCollectable;->mRtlaCrashDetails:Lcom/amazon/device/crashmanager/rtla/RtlaCrashDetails;

    invoke-interface {v2}, Lcom/amazon/device/crashmanager/rtla/RtlaCrashDetails;->getSubPageType()Ljava/lang/String;
    ...
    .line 38
    iget-object v4, p0, Lcom/amazon/device/crashmanager/rtla/RtlaCrashDetailsCollectable;->mRtlaCrashDetails:Lcom/amazon/device/crashmanager/rtla/RtlaCrashDetails;

    invoke-interface {v4}, Lcom/amazon/device/crashmanager/rtla/RtlaCrashDetails;->getActiveWebLabs()Ljava/util/List;
    ...
    .line 45
    invoke-direct {p0, p1, v5}, Lcom/amazon/device/crashmanager/rtla/RtlaCrashDetailsCollectable;->defaultOnNull(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 56
    invoke-direct {p0, v3}, Lcom/amazon/device/crashmanager/rtla/RtlaCrashDetailsCollectable;->formatWebLabs(Ljava/util/List;)Ljava/lang/String;
