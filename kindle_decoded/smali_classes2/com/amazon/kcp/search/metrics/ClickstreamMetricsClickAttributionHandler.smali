.class public final Lcom/amazon/kcp/search/metrics/ClickstreamMetricsClickAttributionHandler;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/amazon/kcp/search/metrics/ClickstreamMetricsClickAttributionHandler;->fastMetrics:Lcom/amazon/kindle/fastmetrics/service/client/IKindleFastMetrics;

    return-void
.end method

.method private final buildClickstreamClickAttributionInfoRecord(Lcom/amazon/kcp/search/metrics/AggregatedClickStreamMetricsAttributionRecord;)Lcom/amazon/kcp/search/metrics/ClickStreamClickAttributionInfoRecord;
    .locals 13

    .line 67
    new-instance v12, Lcom/amazon/kcp/search/metrics/ClickStreamClickAttributionInfoRecord;
    ...
    invoke-virtual {p1}, Lcom/amazon/kcp/search/metrics/AggregatedClickStreamMetricsAttributionRecord;->getGlanceView()Ljava/lang/String;

    move-result-object v6

    invoke-virtual {p1}, Lcom/amazon/kcp/search/metrics/AggregatedClickStreamMetricsAttributionRecord;->getSr()Ljava/lang/String;

    move-result-object v7

    .line 70
    invoke-virtual {p1}, Lcom/amazon/kcp/search/metrics/AggregatedClickStreamMetricsAttributionRecord;->getClickAttributionPageTypeId()Ljava/lang/String;
    ...
    .line 67
    invoke-direct/range {v0 .. v11}, Lcom/amazon/kcp/search/metrics/ClickStreamClickAttributionInfoRecord;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ILkotlin/jvm/internal/DefaultConstructorMarker;)V

    .line 72
    invoke-virtual {p1}, Lcom/amazon/kcp/search/metrics/AggregatedClickStreamMetricsAttributionRecord;->getAsinData()Ljava/lang/String;
    ...
    invoke-virtual {v12, p1}, Lcom/amazon/kcp/search/metrics/ClickStreamClickAttributionInfoRecord;->setAsinData(Ljava/lang/String;)V
...
.method private final prepareClickstreamAttributionRecord(Lcom/amazon/kcp/search/metrics/AggregatedClickStreamMetricsAttributionRecord;)Lcom/amazon/kcp/search/metrics/ClickstreamAttributionRecord;
    ...
    .line 58
    invoke-direct {p0, p1}, Lcom/amazon/kcp/search/metrics/ClickstreamMetricsClickAttributionHandler;->buildClickstreamClickAttributionInfoRecord(Lcom/amazon/kcp/search/metrics/AggregatedClickStreamMetricsAttributionRecord;)Lcom/amazon/kcp/search/metrics/ClickStreamClickAttributionInfoRecord;
...
.method public submitRecord(Lcom/amazon/kcp/search/metrics/AggregatedClickStreamMetricsAttributionRecord;)V
    ...
    .line 26
    invoke-direct {p0, p1}, Lcom/amazon/kcp/search/metrics/ClickstreamMetricsClickAttributionHandler;->isValidRecord(Lcom/amazon/kcp/search/metrics/AggregatedClickStreamMetricsAttributionRecord;)Z
    ...
    .line 27
    invoke-static {}, Lcom/amazon/kcp/search/metrics/ClickstreamMetricsClickAttributionHandlerKt;->access$getLOG_TAG$p()Ljava/lang/String;

    move-result-object p1

    const-string v0, "The input record does not contain valid data for all required fields for Clickstream click attribution metrics."
    ...
    .line 32
    :cond_0
    iget-object v0, p0, Lcom/amazon/kcp/search/metrics/ClickstreamMetricsClickAttributionHandler;->fastMetrics:Lcom/amazon/kindle/fastmetrics/service/client/IKindleFastMetrics;
    ...
    .line 33
    invoke-direct {p0, p1}, Lcom/amazon/kcp/search/metrics/ClickstreamMetricsClickAttributionHandler;->prepareClickstreamAttributionRecord(Lcom/amazon/kcp/search/metrics/AggregatedClickStreamMetricsAttributionRecord;)Lcom/amazon/kcp/search/metrics/ClickstreamAttributionRecord;
    ...
    const-string v2, "Clickstream Click Attribution Record: "
    ...
    .line 35
    invoke-direct {p0, v0, p1}, Lcom/amazon/kcp/search/metrics/ClickstreamMetricsClickAttributionHandler;->buildPayload(Lcom/amazon/kindle/fastmetrics/service/client/IPayloadBuilder;Lcom/amazon/kcp/search/metrics/ClickstreamAttributionRecord;)Lcom/amazon/kindle/fastmetrics/service/provider/AbstractPayload;
