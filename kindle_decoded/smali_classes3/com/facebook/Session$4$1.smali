...
.method public run()V
    ...
    iget-object v2, v1, Lcom/facebook/Session$4;->this$0:Lcom/facebook/Session;

    iget-object v3, v1, Lcom/facebook/Session$4;->val$newState:Lcom/facebook/SessionState;

    iget-object v1, v1, Lcom/facebook/Session$4;->val$exception:Ljava/lang/Exception;

    invoke-interface {v0, v2, v3, v1}, Lcom/facebook/Session$StatusCallback;->call(Lcom/facebook/Session;Lcom/facebook/SessionState;Ljava/lang/Exception;)V
